...
class risk_est_model extends MY_Model{
	...
	public $join = 'join division on risk_est.divisionid = division.id 
	...
	public $select = 'risk_est.*, division.title as division_title , section.title as section_title , 
					  objective.title as objective_title , mission.title as mission_title , process.title as process_title ';
